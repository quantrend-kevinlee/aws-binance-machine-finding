...
class EC2Manager:
    ...
    def enable_stop_protection(self, instance_id: str) -> bool:
        ...
        try:
            ...
            print(f"[OK] Enabled stop protection for instance {instance_id}")
            return True
        except ClientError as e:
            print(f"[ERROR] Failed to enable stop protection: {e}")
            return False
        except Exception as e:
            print(f"[ERROR] Unexpected error enabling stop protection: {e}")
            return False